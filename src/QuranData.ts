...
export class QuranData {
    ...
    private getSajdas(): Sajdah[] {
        const r: Sajdah[] = [];
        for (const sajda of this._sajdas) {
            r.push({
                surah: +sajda[0],
                ayah: +sajda[1],
    ...
    private getRukus(): AyatRange[] {
        return this.getAyatRange(this._rukus);
    }

    private getManzils() {
        return this.getAyatRange(this._manzils);
    }

    private getPages() {
        return this.getAyatRange(this._pages);
    }

    private getHizbQuarters() {
        return this.getAyatRange(this._hizb_quarters);
    }
