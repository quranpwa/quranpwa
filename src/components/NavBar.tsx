...
function NavBar({ quranData, navData, onNavigate }: NavBarProps) {
    ...
    return <nav className='navbar fixed-top px-2'>
        <button className="btn btn-dark nav-btn d-none" type="button" title="Menu"
        ...
        <h1 className="nav-title"><img src="/images/quran-rehal.svg" alt="Quran Rehal" height="30" /> Quran PWA</h1>
